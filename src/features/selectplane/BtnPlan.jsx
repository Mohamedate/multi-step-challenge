...
export default function BtnPlan({ image, name, price }) {
  ...
  return (
    <button
      ...
      className={`flex w-full flex-row items-center gap-4 rounded-md border-[1px] border-light-gray p-2 transition-all duration-300 hover:border-purplish-blue hover:bg-mag md:flex-col md:items-start md:gap-12 md:p-4 ${btnStyle}`}
    >
